...
public class RegisterDialog extends DialogFragment implements View.OnClickListener, KeyboardWatcher.SoftKeyboardStateListener, View.OnFocusChangeListener{
    ...
    public RegisterDialog(FragmentManager FragmentManager) {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.register:
                hideKeyboard(v);
                //页面跳转到登录
                LoginDialog loginDialog = new LoginDialog(alarmioFragmentManager);
                loginDialog.show(alarmioFragmentManager, "loginTag");
